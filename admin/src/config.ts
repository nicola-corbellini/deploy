...
const config: Config = {
  ...
  endpoints: {
    chat: 'ws://192.168.1.68:1865/ws',
    rabbitHole: 'http://192.168.1.68:1865/rabbithole',
    allLLM: 'http://192.168.1.68:1865/settings/llm/',
    singleLLM: 'http://192.168.1.68:1865/settings/llm/:llm'
  }
}
